...
if feat_select==1:
    ...
    if fs_type==2:
        rgr = RandomForestRegressor(n_estimators=100,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st) 
...
if binning==0 and cross_val==1:
    ...
    start_ts=time.time()
    rgr = RandomForestRegressor(n_estimators=100,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st) 
    #rgr = RandomForestRegressor(n_estimators=5,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=10,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st) 
    #rgr = RandomForestRegressor(n_estimators=20,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=50,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=200,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=500,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st) 
    #rgr = RandomForestRegressor(n_estimators=1000,criterion="mse", max_features=.33, max_depth=None, min_samples_split=3, random_state=rand_st)
