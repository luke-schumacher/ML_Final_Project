...
if binning==1 and cross_val==1:
    ...
    start_ts=time.time()
    clf= GradientBoostingClassifier(n_estimators=100, loss='deviance', learning_rate= 0.1, max_depth= 3, min_samples_split= 3, random_state=rand_st)
    #clf= GradientBoostingClassifier(n_estimators=100, loss='deviance', learning_rate= 0.1, max_depth= 5, min_samples_split= 3, random_state=rand_st)
    #clf= GradientBoostingClassifier(n_estimators=100, loss='deviance', learning_rate= 0.1, max_depth= 7, min_samples_split= 3, random_state=rand_st)
    #clf= GradientBoostingClassifier(n_estimators=100, loss='deviance', learning_rate= 0.1, max_depth= 10, min_samples_split= 3, random_state=rand_st)
    ...
    scores_Acc = scores['test_Accuracy']                                                                                                                                    
    print("Ada Boosting Accuracy: %0.2f (+/- %0.2f)" % (scores_Acc.mean(), scores_Acc.std() * 2))                                                                                                    
    scores_AUC= scores['test_roc_auc']                                                                     #Only works with binary classes, not multiclass                  
